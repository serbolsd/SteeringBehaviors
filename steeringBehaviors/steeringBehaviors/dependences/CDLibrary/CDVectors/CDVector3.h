...
namespace CD
{
	...
	struct CDVector3
	{
		...
		void set(float xy[2], float z) { this->x = xy[0]; this->y = xy[1], this->z = z; };
		void set(float x, float yz[2]) {this->x = x; this->y = yz[0]; this->z = (yz[1]);};
		void set(float xyz[3]) {this->x = xyz[0]; this->y = xyz[1]; this->z = xyz[2];};
		void set(const CDVector2& xy, float z) {this->x = xy.x; this->y = xy.y;  this->z = z;};
		void set(float x, const CDVector2& yz) { this->x = x; this->y = yz.x; this->z = yz.y;};
	...
	inline void CD::CDVector3::set(float x, float y, float z)
	{
